...
┌─ Global Ref *- Files used by many HTML files*<br>
...
│  └─ MainStyle.css *- Basic CSS used on most HTML files*<br>
├─ Projects<br>
│  └─ *Project* *- Project Name*<br>
├─ HTML Template.py *- Explained Below*<br>
├─ README.md *- This File!*<br>
├─ Template.html *- Explained Below*<br>
